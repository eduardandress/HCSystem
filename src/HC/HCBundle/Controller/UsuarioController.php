...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HCHCBundle:Usuario')->findAll();

        return $this->render('HCHCBundle:Usuario:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('HCHCBundle:Usuario:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Usuario $entity)
    {
        $form = $this->createForm(new UsuarioType(), $entity, array(
            'action' => $this->generateUrl('gestionarusuarios_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HCHCBundle:Usuario')->find($id);
        ...
        return $this->render('HCHCBundle:Usuario:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('HCHCBundle:Usuario:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new UsuarioType(), $entity, array(
            'action' => $this->generateUrl('gestionarusuarios_update', array('id' => $entity->getIdusuario())),
            'method' => 'PUT',
        ));
